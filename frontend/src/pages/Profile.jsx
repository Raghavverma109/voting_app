...
import { User, Mail, Phone, MapPin, Calendar, CreditCard, Shield, Lock, CheckCircle, XCircle } from 'lucide-react'
...
export default function Profile() {
  ...
  const changePw = async (e) => {
    e.preventDefault()
    try {
      console.log("User data testing :", user);
      await api.put('/user/profile/password', { currentPassword: oldPass, newPassword: newPass })
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-30 h-30 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center border-2 border-emerald-200 dark:border-emerald-800 overflow-hidden">
              {user?.profilePhoto ? ( 
                <img
